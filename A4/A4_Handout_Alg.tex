...
Let $p_x, p_y, p_z$ be the components of $p_eye$ and $p_cx, p_cy, and p_cz$ be the components of $p_c$. We know the following:\\
...
\noindent $t^2\left(d_x^2+d_z^2-\frac{1}{4}d_y^2\right)\\+ t\left(2d_xp_x+2d_zp_z+\frac{1}{4}d_y-\frac{1}{2}p_yd_y\right)\\\
